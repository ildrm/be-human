...
export const evidenceRegistry: readonly EvidenceStandard[] = [
  {
    ...
    classification: 'EVIDENCE_BASED_GUIDELINE', sourceUrl: 'https://www.who.int/publications/i/item/9789240015128', publishedOn: '2020-11-25', lastVerifiedOn: '2026-09-18',
  ...
  },
  {
    ...
    sourceUrl: 'https://www.who.int/publications/m/item/WHO-UCN-MSD-MHE-2024.01', publishedOn: '2024-10-02', lastVerifiedOn: '2026-09-18', population: 'Self-report; localized validation and safeguarding policy required', jurisdiction: 'Global', unit: '0–100',
  ...
  },
  {
    ...
    sourceUrl: 'https://doi.org/10.5664/jcsm.4758', publishedOn: '2015-06-01', lastVerifiedOn: '2026-09-18', population: 'Healthy adults aged 18–60', jurisdiction: 'General clinical consensus', unit: 'hours/night', rule: { minimum: 7 }, strength: 'Expert consensus informed by systematic evidence review', limitations: 'Need varies. More than nine hours may be appropriate for young adults, recovery, and illness. Does not diagnose sleep disorders.', license: 'Citation and summary only', status: 'active',
  },
  {
    ...
    sourceUrl: 'https://www.who.int/health-topics/healthy-diet', publishedOn: '2026-01-01', lastVerifiedOn: '2026-09-18', population: 'General population; age and clinical applicability required', jurisdiction: 'Global', unit: 'mixed', rule: { freeSugarEnergyFractionMax: 0.1, totalFatEnergyFractionMax: 0.3, sodiumMgMax: 2000, fruitVegetableGramsMinAdults: 400 }, strength: 'WHO guideline summary', limitations: 'Not individualized medical nutrition advice. Access, culture, allergies, pregnancy, illness, and professional restrictions affect applicability.', license: 'WHO website terms', status: 'active',
  },
  {
